...
/********************SPI Instruction Layer begin*************************************
 Implement the 6 SPI instruction of MCP2510,including READ,WRITE,READ STATUS,BIT MOD-
 IFY and RESET.
...
//Implemetn Read Status Instruction of mcp2510
...
/********************Set Configuration Mode******************************************
 ...
 Configuration mode is automatically selected after powerup or a reset, or can be en-
 tered from any other mode by setting the CANCTRL.REQOP bits to ¡®100¡¯.
...
/****************initialize parameter in configuration mode begin***************/	
	...
	//Set Interput , all interrup enabled
	...
	//set filter mask to 0,means we donnot do filter
	//for RXB0
...
{	
	...
	for(i = 0; i<length; i++)
	{
	//according to page22-7 of s3c2410 datasheet,in normal mode if only want to receive data
